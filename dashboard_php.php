...
<body>
    ...
    <div class="container">
        <div class="menu-links">
            ...
            <a href="attendance_php_fixed.php" class="menu-link">📋 Attendance</a>
            <a href="payroll_php.php" class="menu-link">💰 Payroll</a>
            <a href="reports_php.php" class="menu-link">📊 Reports</a>
        </div>
