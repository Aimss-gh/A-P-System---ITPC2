...
if(isset($_POST['generate_payroll'])) {
    ...
    // If hourly rate exists, calculate based on hours worked
    if($hourly_rate > 0) {
        $basic_salary = $total_hours * $hourly_rate;
        // Overtime pay (1.5x rate)
        $overtime_pay = $overtime_hours * $hourly_rate * 1.5;
    } else {
        // If using monthly salary, calculate hourly rate (assuming 8 hours/day, 22 working days)
    ...
    header("Location: payroll_php.php");
    exit();
}
...
// Fetch payroll records with employee names
...
<body>
    <div class="header">
        ...
        <div class="nav-links">
               <a href="dashboard_php.php">Dashboard</a>
            <a href="employees_page.php">Employees</a>
            <a href="attendance_php_fixed.php">Attendance</a>
            <a href="payroll_php.php">Payroll</a>
            <a href="reports_php.php">Reports</a>
    ...
    <script>
        function confirmDelete(id) {
            if(confirm('Are you sure you want to delete this payroll record?')) {
                window.location.href = 'payroll_php.php?delete_id=' + id;
            }
        }
